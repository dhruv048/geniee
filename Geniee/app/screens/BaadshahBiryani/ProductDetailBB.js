...
class ProductDetailBB extends Component {
            ...
            <Container style={customStyle.Container}>
                ...
                <View style={{
                   ...
                   // justifyContent: 'space-between',
                    ...
                    {this.state.product ?
                        <Text numberOfLines={1} note style={{color: 'white', marginLeft:25}}>{this.state.product.title}</Text> : null}
                    {/*<TouchableOpacity style={{*/}
                        {/*alignSelf: 'center',*/}
                        {/*justifyContent: 'center',*/}
                        {/*alignItems: 'center',*/}
                        ...
                        <View style={{padding: 16, backgroundColor: '#fff'}}>
                            ...
                            <Text style={{
                                ...
                                <Text style={{fontSize: 16}}
                                      note> ({this.state.product.isVeg ==1? "Veg" : "Non-Veg"})</Text>
                            </Text>
                            ...
                            <Grid style={{marginTop: 15}}>
                                ...
                                <Col size={1}>
                                    <Button block
                                         onPress={()=>MyFunctions._callPhone('9847338067')}
                                            style={[customStyle.buttonPrimary, {marginRight: 5}]}>
                                     <Text style={customStyle.buttonPrimaryText}><FIcon name={'phone'} size={24} color="white"/>   Order Now</Text>
                                    </Button>
                                </Col>
                            </Grid>
                        </View>
    ...
    _renderItem = ({item, index}) => {
        return (
            <TouchableWithoutFeedback
                key={index}
                onPress={() => goToRoute(this.props.componentId,'ImageGalleryBB', {
    ...
    _renderProduct = (data, index) => {
        let item = data.item;
        return (
            <TouchableOpacity onPress={() => goToRoute(this.props.componentId, "ProductDetailBB",{'Id': item._id, data: item})}
