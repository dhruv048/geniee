...
import {Container, Content, Text, View, Header,Item, Icon as NBIcon, Input,Button,ListItem,Left,Right,Thumbnail,
Body,Card,CardItem} from "native-base";
import {colors, customStyle} from "../config/styles";
import {FlatList,StyleSheet,Dimensions,TouchableWithoutFeedback,TouchableOpacity,Image} from "react-native";
                ...
                <Card key={item._id} style={customStyle.Card}>
                    <CardItem cardBody style={{width: '100%'}}>
                        ...
                        <View style={{
                            ...
                            {item.discount?
                                <View style={{position: 'absolute',top:0,right:0,backgroundColor:colors.primary, opacity:1,borderRadius:5, textAlign:'center',padding:2}}>
                                    <Text style={{fontSize:10,color:'white'}}>{item.discount}% off</Text>
                                </View>
                                :null}
                        </View>
            ...
            <Content>
                <Header searchBar rounded androidStatusBarColor={colors.statusBar}
                    ...
                    <Item style={{height: 40, width: '95%', paddingLeft: 10}}>
                        <Button onPress={()=>goBack()} style={{paddingHorizontal:10}} transparent>
                        ...
                        />
                        {/*<Right>*/}
                        <Button style={{paddingHorizontal: 5}} transparent onPress={()=>this.setState({query:""})}>
