...
class AllProducts extends Component {
  ...
  _onEndReached = distance => {
    ...
    if (this.state.filterOption == 'popular') this._fetchData();
  };
      ...
      <Provider theme={customPaperTheme}>
        <Container style={styles.container}>
          ...
          <ActionSheet
            ...
            <View nestedScrollEnabled={true} style={styles.actionContentView}>
              <View
              ...
              <TouchableOpacity
                ...
                <RadioButton
                  status={
                    this.state.filterOption == 'popular'
                      ? 'checked'
                      : 'unchecked'
                  }
              ...
              {userId ? (
                <TouchableOpacity
                  ...
                  <RadioButton
                    status={
                      this.state.filterOption == 'myProducts'
                        ? 'checked'
                        : 'unchecked'
                    }
                    color={colors.primary}
